...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Pheem Hub BF Premium') then
        makefolder('Pheem Hub BF Premium')
    end
    if not _G.Dis and not isfile('Switch Hub BF Premium/'..Name..'.json') then
        writefile('Pheem Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Pheem Hub BF Premium') and isfile('Pheem Hub BF Premium/'..Name..'.json') then
...
getgenv()['Update_Setting'] = function(Name)
    if not _G.Dis and isfolder('Pheem Hub BF Premium') and isfile('Pheem Hub BF Premium/'..Name..'.json') then
        writefile('Pheem BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
	elseif not _G.Dis then
        Check_Setting(Name)
    end
end
...
local win = library:Window("Pheem",[[Hub]],[[Version : Premium ]],"9606070311",Enum.KeyCode.RightControl)
